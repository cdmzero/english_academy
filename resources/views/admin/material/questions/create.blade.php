            ...
            <div class="card-body">
                <form action="{{ route('admin.question.store') }}"  method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="option_title" type="text" class="form-control @error('option_title') is-invalid @enderror" name="option_title[]" placeholder="Option number 1" value="" required autocomplete="option_title" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="option_title" type="text" class="form-control @error('option_title') is-invalid @enderror" name="option_title[]" placeholder="Test Name" value="" required autocomplete="option_title" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="option_title" type="text" class="form-control @error('option_title') is-invalid @enderror" name="option_title[]" placeholder="Test Name" value="{{ old('test_name') }}" required autocomplete="option_title" autofocus>
